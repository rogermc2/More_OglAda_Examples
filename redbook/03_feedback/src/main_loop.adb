...
procedure Main_Loop (Main_Window :  in out Glfw.Windows.Window) is
    ...
    begin
        ...
        if not GL.Objects.Programs.Link_Status (Update_Program) then
            Put_Line ("Main_Loop.Setup, initial Update_Program Link failed");
            ...
            --
            if not GL.Objects.Programs.Link_Status (Update_Program) then
                Put_Line ("Main_Loop.Setup, Update_Program Link failed");
                Put_Line (GL.Objects.Programs.Info_Log (Update_Program));
            else
                Put_Line ("Main_Loop.Setup, Update_Program Link ok");
            end if;
        end if;

        GL.Objects.Programs.Use_Program  (Update_Program);
        Put_Line ("Main_Loop.Setup, using Update_Program");
