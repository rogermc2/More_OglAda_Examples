pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__trivial.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__trivial.adb");
...
package body ada_main is
   ...
   begin
      ...
      declare
         procedure F5;
         pragma Import (Ada, F5, "gl__objects__buffers__finalize_body");
      begin
         E153 := E153 - 1;
         F5;
      end;
      declare
         procedure F6;
         pragma Import (Ada, F6, "gl__objects__renderbuffers__finalize_body");
      begin
         E187 := E187 - 1;
         F6;
      end;
      ...
      declare
         procedure F8;
         pragma Import (Ada, F8, "gl__objects__textures__finalize_body");
      begin
         E189 := E189 - 1;
         F8;
      end;
      ...
      declare
         procedure F10;
         pragma Import (Ada, F10, "gl__fixed__lighting__finalize_spec");
      begin
         F10;
      end;
      declare
         procedure F11;
         pragma Import (Ada, F11, "gl__objects__buffers__finalize_spec");
      begin
         F11;
      end;
      declare
      ...
      declare
         procedure F13;
         pragma Import (Ada, F13, "gl__objects__textures__finalize_spec");
      begin
         F13;
      end;
      declare
         procedure F14;
         pragma Import (Ada, F14, "gl__objects__programs__finalize_spec");
      begin
         F14;
      end;
      declare
         procedure F15;
         pragma Import (Ada, F15, "gl__objects__shaders__finalize_spec");
      begin
         F15;
      end;
      E171 := E171 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_trivial");
...
--  BEGIN Object file/option list
   ...
   --   /Ada_Source/OpenGLAda/examples/durian/hello/obj/trivial.o
