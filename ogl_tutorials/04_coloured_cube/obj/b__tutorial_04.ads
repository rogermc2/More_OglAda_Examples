...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_tutorial_04" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#688c6b23#;
   pragma Export (C, u00001, "tutorial_04B");
   ...
   u00257 : constant Version_32 := 16#3a9cbdf3#;
   pragma Export (C, u00257, "main_loopB");
   u00258 : constant Version_32 := 16#bdd35137#;
   pragma Export (C, u00258, "main_loopS");
   u00259 : constant Version_32 := 16#8b7fd645#;
   pragma Export (C, u00259, "cube_dataS");
   u00260 : constant Version_32 := 16#5d7c9f31#;
   pragma Export (C, u00260, "gl__objects__vertex_arraysB");
   u00261 : constant Version_32 := 16#1d5a67ec#;
   pragma Export (C, u00261, "gl__objects__vertex_arraysS");
   u00262 : constant Version_32 := 16#775a1c4d#;
   pragma Export (C, u00262, "gl__windowB");
   u00263 : constant Version_32 := 16#24a263f4#;
   pragma Export (C, u00263, "gl__windowS");
   u00264 : constant Version_32 := 16#185e2091#;
   pragma Export (C, u00264, "program_loaderB");
   u00265 : constant Version_32 := 16#bd70322f#;
   pragma Export (C, u00265, "program_loaderS");
   u00266 : constant Version_32 := 16#e6195f7f#;
   pragma Export (C, u00266, "ada__directoriesB");
   u00267 : constant Version_32 := 16#9da5f6a3#;
   pragma Export (C, u00267, "ada__directoriesS");
   u00268 : constant Version_32 := 16#b8719323#;
   pragma Export (C, u00268, "ada__calendarB");
   u00269 : constant Version_32 := 16#41508869#;
   pragma Export (C, u00269, "ada__calendarS");
   u00270 : constant Version_32 := 16#2b2125d3#;
   pragma Export (C, u00270, "system__os_primitivesB");
   u00271 : constant Version_32 := 16#0fa60a0d#;
   pragma Export (C, u00271, "system__os_primitivesS");
   u00272 : constant Version_32 := 16#95569f93#;
   pragma Export (C, u00272, "ada__calendar__formattingB");
   u00273 : constant Version_32 := 16#7ddaf16f#;
   ...
   u00275 : constant Version_32 := 16#77b56b93#;
   pragma Export (C, u00275, "ada__calendar__time_zonesS");
   u00276 : constant Version_32 := 16#d763507a#;
   pragma Export (C, u00276, "system__val_intB");
   u00277 : constant Version_32 := 16#40fe45c4#;
   pragma Export (C, u00277, "system__val_intS");
   u00278 : constant Version_32 := 16#1d9142a4#;
   pragma Export (C, u00278, "system__val_unsB");
   u00279 : constant Version_32 := 16#2c75fe43#;
   pragma Export (C, u00279, "system__val_unsS");
   u00280 : constant Version_32 := 16#c2ca0511#;
   pragma Export (C, u00280, "system__val_realB");
   u00281 : constant Version_32 := 16#f67218ea#;
   pragma Export (C, u00281, "system__val_realS");
   u00282 : constant Version_32 := 16#8f637df8#;
   pragma Export (C, u00282, "ada__characters__handlingB");
   u00283 : constant Version_32 := 16#3b3f6154#;
   pragma Export (C, u00283, "ada__characters__handlingS");
   u00284 : constant Version_32 := 16#92f05f13#;
   pragma Export (C, u00284, "ada__strings__maps__constantsS");
   u00285 : constant Version_32 := 16#ab4ad33a#;
   pragma Export (C, u00285, "ada__directories__validityB");
   u00286 : constant Version_32 := 16#498b13d5#;
   pragma Export (C, u00286, "ada__directories__validityS");
   u00287 : constant Version_32 := 16#2f6496d9#;
   pragma Export (C, u00287, "system__file_attributesS");
   u00288 : constant Version_32 := 16#54ea2fd2#;
   pragma Export (C, u00288, "system__os_constantsS");
   u00289 : constant Version_32 := 16#95f86c43#;
   pragma Export (C, u00289, "system__regexpB");
   u00290 : constant Version_32 := 16#2b69c837#;
   pragma Export (C, u00290, "system__regexpS");
   u00291 : constant Version_32 := 16#06e78f59#;
   pragma Export (C, u00291, "gl__filesB");
   u00292 : constant Version_32 := 16#07708aff#;
   pragma Export (C, u00292, "gl__filesS");
   u00293 : constant Version_32 := 16#0460865d#;
   pragma Export (C, u00293, "system__direct_ioB");
   u00294 : constant Version_32 := 16#aa3a89c5#;
   pragma Export (C, u00294, "system__direct_ioS");
