...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_textured_cube" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#5a7c34b0#;
   pragma Export (C, u00001, "textured_cubeB");
   ...
   u00257 : constant Version_32 := 16#afe2fddd#;
   pragma Export (C, u00257, "main_loopB");
   u00258 : constant Version_32 := 16#bdd35137#;
   pragma Export (C, u00258, "main_loopS");
   u00259 : constant Version_32 := 16#59706f04#;
   pragma Export (C, u00259, "cube_dataS");
   u00260 : constant Version_32 := 16#2f213b03#;
   pragma Export (C, u00260, "gl__objects__textures__targetsB");
   u00261 : constant Version_32 := 16#f6ffc087#;
   pragma Export (C, u00261, "gl__objects__textures__targetsS");
   u00262 : constant Version_32 := 16#c8eda0b7#;
   pragma Export (C, u00262, "system__taskingB");
   u00263 : constant Version_32 := 16#904e70c9#;
   pragma Export (C, u00263, "system__taskingS");
   u00264 : constant Version_32 := 16#fde20231#;
   pragma Export (C, u00264, "system__task_primitivesS");
   u00265 : constant Version_32 := 16#4a005d03#;
   pragma Export (C, u00265, "system__os_interfaceB");
   u00266 : constant Version_32 := 16#55598295#;
   pragma Export (C, u00266, "system__os_interfaceS");
   u00267 : constant Version_32 := 16#1b8990a4#;
   pragma Export (C, u00267, "interfaces__c__extensionsS");
   u00268 : constant Version_32 := 16#54ea2fd2#;
   pragma Export (C, u00268, "system__os_constantsS");
   u00269 : constant Version_32 := 16#9690f83e#;
   pragma Export (C, u00269, "system__task_primitives__operationsB");
   u00270 : constant Version_32 := 16#bd0bc49c#;
   pragma Export (C, u00270, "system__task_primitives__operationsS");
   u00271 : constant Version_32 := 16#89b55e64#;
   pragma Export (C, u00271, "system__interrupt_managementB");
   u00272 : constant Version_32 := 16#1a73cd21#;
   pragma Export (C, u00272, "system__interrupt_managementS");
   u00273 : constant Version_32 := 16#f65595cf#;
   pragma Export (C, u00273, "system__multiprocessorsB");
   u00274 : constant Version_32 := 16#30f7f088#;
   pragma Export (C, u00274, "system__multiprocessorsS");
   u00275 : constant Version_32 := 16#2b2125d3#;
   pragma Export (C, u00275, "system__os_primitivesB");
   u00276 : constant Version_32 := 16#0fa60a0d#;
   pragma Export (C, u00276, "system__os_primitivesS");
   u00277 : constant Version_32 := 16#e0fce7f8#;
   pragma Export (C, u00277, "system__task_infoB");
   u00278 : constant Version_32 := 16#8841d2fa#;
   pragma Export (C, u00278, "system__task_infoS");
   u00279 : constant Version_32 := 16#1036f432#;
   pragma Export (C, u00279, "system__tasking__debugB");
   u00280 : constant Version_32 := 16#de1ac8b1#;
   pragma Export (C, u00280, "system__tasking__debugS");
   u00281 : constant Version_32 := 16#fd83e873#;
   pragma Export (C, u00281, "system__concat_2B");
   u00282 : constant Version_32 := 16#0afbb82b#;
   pragma Export (C, u00282, "system__concat_2S");
   u00283 : constant Version_32 := 16#2b70b149#;
   pragma Export (C, u00283, "system__concat_3B");
   u00284 : constant Version_32 := 16#032b335e#;
   pragma Export (C, u00284, "system__concat_3S");
   u00285 : constant Version_32 := 16#273384e4#;
   pragma Export (C, u00285, "system__img_enum_newB");
   u00286 : constant Version_32 := 16#6917693b#;
   pragma Export (C, u00286, "system__img_enum_newS");
   u00287 : constant Version_32 := 16#9dca6636#;
   pragma Export (C, u00287, "system__img_lliB");
   u00288 : constant Version_32 := 16#19143a2a#;
   pragma Export (C, u00288, "system__img_lliS");
   u00289 : constant Version_32 := 16#6ec3c867#;
   pragma Export (C, u00289, "system__stack_usageB");
   u00290 : constant Version_32 := 16#3a3ac346#;
   pragma Export (C, u00290, "system__stack_usageS");
   u00291 : constant Version_32 := 16#c8bd942f#;
   pragma Export (C, u00291, "gl__objects__textures__with_1d_loaderB");
   u00292 : constant Version_32 := 16#d32d8e5b#;
   pragma Export (C, u00292, "gl__objects__textures__with_1d_loaderS");
   u00293 : constant Version_32 := 16#4aa03121#;
   pragma Export (C, u00293, "gl__objects__textures__with_2d_loaderB");
   u00294 : constant Version_32 := 16#a46acc9c#;
   pragma Export (C, u00294, "gl__objects__textures__with_2d_loaderS");
   u00295 : constant Version_32 := 16#41d56d85#;
   pragma Export (C, u00295, "gl__objects__textures__with_3d_loaderB");
   u00296 : constant Version_32 := 16#1998073c#;
   pragma Export (C, u00296, "gl__objects__textures__with_3d_loaderS");
   u00297 : constant Version_32 := 16#5d7c9f31#;
   pragma Export (C, u00297, "gl__objects__vertex_arraysB");
   u00298 : constant Version_32 := 16#1d5a67ec#;
   pragma Export (C, u00298, "gl__objects__vertex_arraysS");
   u00299 : constant Version_32 := 16#5d2af317#;
   pragma Export (C, u00299, "load_ddsB");
   u00300 : constant Version_32 := 16#e982b59f#;
   pragma Export (C, u00300, "load_ddsS");
   u00301 : constant Version_32 := 16#185e2091#;
   pragma Export (C, u00301, "program_loaderB");
   u00302 : constant Version_32 := 16#bd70322f#;
   pragma Export (C, u00302, "program_loaderS");
   u00303 : constant Version_32 := 16#e6195f7f#;
   pragma Export (C, u00303, "ada__directoriesB");
   u00304 : constant Version_32 := 16#9da5f6a3#;
   pragma Export (C, u00304, "ada__directoriesS");
   u00305 : constant Version_32 := 16#b8719323#;
   pragma Export (C, u00305, "ada__calendarB");
   u00306 : constant Version_32 := 16#41508869#;
   pragma Export (C, u00306, "ada__calendarS");
   u00307 : constant Version_32 := 16#95569f93#;
   pragma Export (C, u00307, "ada__calendar__formattingB");
   u00308 : constant Version_32 := 16#7ddaf16f#;
   pragma Export (C, u00308, "ada__calendar__formattingS");
   u00309 : constant Version_32 := 16#e3cca715#;
   pragma Export (C, u00309, "ada__calendar__time_zonesB");
   u00310 : constant Version_32 := 16#77b56b93#;
   pragma Export (C, u00310, "ada__calendar__time_zonesS");
   u00311 : constant Version_32 := 16#d763507a#;
   pragma Export (C, u00311, "system__val_intB");
   u00312 : constant Version_32 := 16#40fe45c4#;
   pragma Export (C, u00312, "system__val_intS");
   u00313 : constant Version_32 := 16#1d9142a4#;
   pragma Export (C, u00313, "system__val_unsB");
   u00314 : constant Version_32 := 16#2c75fe43#;
   pragma Export (C, u00314, "system__val_unsS");
   u00315 : constant Version_32 := 16#c2ca0511#;
   pragma Export (C, u00315, "system__val_realB");
   u00316 : constant Version_32 := 16#f67218ea#;
   pragma Export (C, u00316, "system__val_realS");
   u00317 : constant Version_32 := 16#8f637df8#;
   pragma Export (C, u00317, "ada__characters__handlingB");
   u00318 : constant Version_32 := 16#3b3f6154#;
   pragma Export (C, u00318, "ada__characters__handlingS");
   u00319 : constant Version_32 := 16#92f05f13#;
   pragma Export (C, u00319, "ada__strings__maps__constantsS");
   u00320 : constant Version_32 := 16#ab4ad33a#;
   pragma Export (C, u00320, "ada__directories__validityB");
   u00321 : constant Version_32 := 16#498b13d5#;
   pragma Export (C, u00321, "ada__directories__validityS");
   u00322 : constant Version_32 := 16#2f6496d9#;
   pragma Export (C, u00322, "system__file_attributesS");
   u00323 : constant Version_32 := 16#95f86c43#;
   pragma Export (C, u00323, "system__regexpB");
   u00324 : constant Version_32 := 16#2b69c837#;
   pragma Export (C, u00324, "system__regexpS");
   u00325 : constant Version_32 := 16#06e78f59#;
   pragma Export (C, u00325, "gl__filesB");
   u00326 : constant Version_32 := 16#07708aff#;
   pragma Export (C, u00326, "gl__filesS");
   u00327 : constant Version_32 := 16#0460865d#;
   pragma Export (C, u00327, "system__direct_ioB");
   u00328 : constant Version_32 := 16#aa3a89c5#;
   pragma Export (C, u00328, "system__direct_ioS");
