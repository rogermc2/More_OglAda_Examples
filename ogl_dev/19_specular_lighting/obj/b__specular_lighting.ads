...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_specular_lighting" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#a8a774a0#;
   pragma Export (C, u00001, "specular_lightingB");
   ...
   u00273 : constant Version_32 := 16#bfb0ee81#;
   ...
   u00312 : constant Version_32 := 16#7b5d1dc2#;
   pragma Export (C, u00312, "lighting_techniqueB");
   u00313 : constant Version_32 := 16#7aca1ab0#;
   ...
   u00344 : constant Version_32 := 16#69a39772#;
   pragma Export (C, u00344, "ogldev_mathB");
   u00345 : constant Version_32 := 16#e041bb51#;
   ...
   u00347 : constant Version_32 := 16#23e63127#;
   pragma Export (C, u00347, "api_vectors_matricesS");
   u00348 : constant Version_32 := 16#cdf47cb9#;
   pragma Export (C, u00348, "assimp_typesS");
   u00349 : constant Version_32 := 16#45e248ec#;
   pragma Export (C, u00349, "ogldev_pipelineB");
   u00350 : constant Version_32 := 16#fda84fc1#;
   pragma Export (C, u00350, "ogldev_pipelineS");
   u00351 : constant Version_32 := 16#e2db7a97#;
   pragma Export (C, u00351, "ogldev_textureB");
   u00352 : constant Version_32 := 16#8be1add2#;
   pragma Export (C, u00352, "ogldev_textureS");
   u00353 : constant Version_32 := 16#622ef959#;
   pragma Export (C, u00353, "magick_blobB");
   u00354 : constant Version_32 := 16#4b00bb5e#;
   pragma Export (C, u00354, "magick_blobS");
   u00355 : constant Version_32 := 16#3bd4d6c1#;
   pragma Export (C, u00355, "magick_blob__apiS");
   u00356 : constant Version_32 := 16#95bf520f#;
   pragma Export (C, u00356, "blob_referenceS");
   u00357 : constant Version_32 := 16#8bfaf470#;
   pragma Export (C, u00357, "core_blobB");
   u00358 : constant Version_32 := 16#d1053d88#;
   pragma Export (C, u00358, "core_blobS");
   u00359 : constant Version_32 := 16#dbe9ed6e#;
   pragma Export (C, u00359, "magick_typeB");
   u00360 : constant Version_32 := 16#7785c8f7#;
   pragma Export (C, u00360, "magick_typeS");
   u00361 : constant Version_32 := 16#35df64f0#;
   pragma Export (C, u00361, "method_attributeS");
   u00362 : constant Version_32 := 16#53ad6155#;
   pragma Export (C, u00362, "semaphoreS");
   u00363 : constant Version_32 := 16#49b21dba#;
   pragma Export (C, u00363, "threadS");
   u00364 : constant Version_32 := 16#d389491e#;
   pragma Export (C, u00364, "sys_pthread_mutexS");
   u00365 : constant Version_32 := 16#69226a62#;
   pragma Export (C, u00365, "sys_pthread_typesS");
   u00366 : constant Version_32 := 16#78534528#;
   pragma Export (C, u00366, "streamS");
   u00367 : constant Version_32 := 16#f6d2357a#;
   pragma Export (C, u00367, "core_imageB");
   u00368 : constant Version_32 := 16#9cd5aa63#;
   pragma Export (C, u00368, "core_imageS");
   u00369 : constant Version_32 := 16#22ecdf37#;
   pragma Export (C, u00369, "cacheS");
   u00370 : constant Version_32 := 16#87ef8a9e#;
   pragma Export (C, u00370, "colourS");
   u00371 : constant Version_32 := 16#f63ada63#;
   pragma Export (C, u00371, "magick_exceptionB");
   u00372 : constant Version_32 := 16#5ac5357b#;
   pragma Export (C, u00372, "magick_exceptionS");
   u00373 : constant Version_32 := 16#7d87fa07#;
   pragma Export (C, u00373, "magick_pixelB");
   u00374 : constant Version_32 := 16#5e69ed76#;
   pragma Export (C, u00374, "magick_pixelS");
   u00375 : constant Version_32 := 16#db19c26b#;
   pragma Export (C, u00375, "colour_spaceS");
   u00376 : constant Version_32 := 16#e68156d9#;
   pragma Export (C, u00376, "compositeS");
   u00377 : constant Version_32 := 16#094fb960#;
   pragma Export (C, u00377, "compressS");
   u00378 : constant Version_32 := 16#642319d6#;
   pragma Export (C, u00378, "core_blob__apiS");
   u00379 : constant Version_32 := 16#12a77ece#;
   pragma Export (C, u00379, "std_ioS");
   u00380 : constant Version_32 := 16#d2264924#;
   pragma Export (C, u00380, "geometryS");
   u00381 : constant Version_32 := 16#e62db32d#;
   pragma Export (C, u00381, "layerS");
   u00382 : constant Version_32 := 16#95bae204#;
   pragma Export (C, u00382, "magick_profileS");
   u00383 : constant Version_32 := 16#439df4d2#;
   pragma Export (C, u00383, "methodS");
   u00384 : constant Version_32 := 16#cfe9dadb#;
   pragma Export (C, u00384, "monitorS");
   u00385 : constant Version_32 := 16#7d9e2ba3#;
   pragma Export (C, u00385, "quantumS");
   u00386 : constant Version_32 := 16#3b4f34f4#;
   pragma Export (C, u00386, "resampleS");
   u00387 : constant Version_32 := 16#14500f3d#;
   pragma Export (C, u00387, "timerS");
   u00388 : constant Version_32 := 16#ed186219#;
   pragma Export (C, u00388, "magick_imageB");
   u00389 : constant Version_32 := 16#4ab6a8e3#;
   pragma Export (C, u00389, "magick_imageS");
   u00390 : constant Version_32 := 16#45273d41#;
   pragma Export (C, u00390, "magick_image__apiS");
   u00391 : constant Version_32 := 16#df84ea6d#;
   pragma Export (C, u00391, "image_referenceS");
   u00392 : constant Version_32 := 16#948c2841#;
   pragma Export (C, u00392, "magick_optionsS");
   u00393 : constant Version_32 := 16#f4eb32b3#;
   pragma Export (C, u00393, "drawS");
   u00394 : constant Version_32 := 16#ff9d83ad#;
   pragma Export (C, u00394, "quantizeS");
   u00395 : constant Version_32 := 16#7f23b26e#;
   pragma Export (C, u00395, "ogldev_engine_commonS");
