...
package body Lighting_Technique_24 is 
   ...
   function Get_Uniform_Location (theTechnique : Technique; Uniform_Name : String)
    ...
    begin
        theTechnique.Lighting_Program := Program_From
          ((Src ("src/shaders/lighting_24.vs", Vertex_Shader),
           Src ("src/shaders/lighting_24.fs", Fragment_Shader)));
   ...
   procedure Set_Directional_Light_Locations (theTechnique : Technique;
    ...
    begin
        GL.Objects.Programs.Use_Program (theTechnique.Lighting_Program);
        GL.Uniforms.Set_Single (theTechnique.Eye_World_Pos_Location, Eye_World_Pos);
   ...
   procedure Set_World_Matrix_Location (theTechnique  : Technique;
        ...
        if GL.Objects.Programs.Validate_Status (theTechnique.Lighting_Program) then
            ...
            begin
                if Curs = GL.Objects.Shaders.Lists.No_Element then
                    Put_Line ("Lighting_Technique_24.Use_Program, Shaders list is empty");
                else
                    GL.Objects.Programs.Use_Program (theTechnique.Lighting_Program);
                end if;
            end;  -- declare block
    ...
    exception
        when  others =>
            Put_Line ("An exception occurred in Lighting_Technique_24.Use_Program.");
            raise;
    end Use_Program;

    --  -------------------------------------------------------------------------
    
end Lighting_Technique_24;
