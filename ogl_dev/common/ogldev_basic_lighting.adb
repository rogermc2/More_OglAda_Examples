...
package body Ogldev_Basic_Lighting is
   ...
   procedure Add_Point_To_ATB (theLight : Point_Lights; Bar : Ant_Tweak_Bar.TW_Bar) is
   begin
      null;
   ...
   procedure Add_Spot_To_ATB (theLight : Spot_Lights; Bar : Ant_Tweak_Bar.TW_Bar) is
   begin
      null;
   end Add_Spot_To_ATB;
