...
package body AI_Conversion is
   ...
   begin
      ...
      --           begin
      --              theProperties_Array := Material.API_Property_Array_Package.Value
      --                (Property_Array_Ptr, ptrdiff_t (Num_Property));
...
--                                             API_Property);
      ...
      Put_Line ("AI_Conversion.To_AI_Property, Data_Length: " &
