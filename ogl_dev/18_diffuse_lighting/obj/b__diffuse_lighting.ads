...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_diffuse_lighting" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#51c38617#;
   pragma Export (C, u00001, "diffuse_lightingB");
   ...
   u00312 : constant Version_32 := 16#9de46143#;
   pragma Export (C, u00312, "lighting_techniqueB");
   u00313 : constant Version_32 := 16#13ac7189#;
   pragma Export (C, u00313, "lighting_techniqueS");
   ...
   u00342 : constant Version_32 := 16#5f4dfa6b#;
   pragma Export (C, u00342, "ogldev_cameraB");
   u00343 : constant Version_32 := 16#1d4e16a1#;
   pragma Export (C, u00343, "ogldev_cameraS");
   u00344 : constant Version_32 := 16#1b606804#;
   pragma Export (C, u00344, "ogldev_mathB");
   u00345 : constant Version_32 := 16#bdcae620#;
   pragma Export (C, u00345, "ogldev_mathS");
   u00346 : constant Version_32 := 16#8225628b#;
   pragma Export (C, u00346, "ada__containers__red_black_treesS");
   u00347 : constant Version_32 := 16#9fb0398c#;
   pragma Export (C, u00347, "assimp_typesS");
   u00348 : constant Version_32 := 16#67b5cf8a#;
   pragma Export (C, u00348, "api_vectorsS");
   u00349 : constant Version_32 := 16#6ad167f4#;
   pragma Export (C, u00349, "matrix_4x4S");
   u00350 : constant Version_32 := 16#4749f8d6#;
   pragma Export (C, u00350, "ogldev_pipelineB");
   u00351 : constant Version_32 := 16#ff03fffb#;
   pragma Export (C, u00351, "ogldev_pipelineS");
   u00352 : constant Version_32 := 16#f7662e40#;
   pragma Export (C, u00352, "ogldev_textureB");
   u00353 : constant Version_32 := 16#960796fe#;
   pragma Export (C, u00353, "ogldev_textureS");
   u00354 : constant Version_32 := 16#622ef959#;
   pragma Export (C, u00354, "magick_blobB");
   u00355 : constant Version_32 := 16#4b00bb5e#;
   pragma Export (C, u00355, "magick_blobS");
   u00356 : constant Version_32 := 16#3bd4d6c1#;
   pragma Export (C, u00356, "magick_blob__apiS");
   u00357 : constant Version_32 := 16#95bf520f#;
   pragma Export (C, u00357, "blob_referenceS");
   u00358 : constant Version_32 := 16#8bfaf470#;
   pragma Export (C, u00358, "core_blobB");
   u00359 : constant Version_32 := 16#d1053d88#;
   pragma Export (C, u00359, "core_blobS");
   u00360 : constant Version_32 := 16#dbe9ed6e#;
   pragma Export (C, u00360, "magick_typeB");
   u00361 : constant Version_32 := 16#7785c8f7#;
   pragma Export (C, u00361, "magick_typeS");
   u00362 : constant Version_32 := 16#35df64f0#;
   pragma Export (C, u00362, "method_attributeS");
   u00363 : constant Version_32 := 16#53ad6155#;
   pragma Export (C, u00363, "semaphoreS");
   u00364 : constant Version_32 := 16#49b21dba#;
   pragma Export (C, u00364, "threadS");
   u00365 : constant Version_32 := 16#d389491e#;
   pragma Export (C, u00365, "sys_pthread_mutexS");
   u00366 : constant Version_32 := 16#69226a62#;
   pragma Export (C, u00366, "sys_pthread_typesS");
   u00367 : constant Version_32 := 16#78534528#;
   pragma Export (C, u00367, "streamS");
   u00368 : constant Version_32 := 16#f6d2357a#;
   pragma Export (C, u00368, "core_imageB");
   u00369 : constant Version_32 := 16#9cd5aa63#;
   pragma Export (C, u00369, "core_imageS");
   u00370 : constant Version_32 := 16#22ecdf37#;
   pragma Export (C, u00370, "cacheS");
   u00371 : constant Version_32 := 16#87ef8a9e#;
   pragma Export (C, u00371, "colourS");
   u00372 : constant Version_32 := 16#f63ada63#;
   pragma Export (C, u00372, "magick_exceptionB");
   u00373 : constant Version_32 := 16#5ac5357b#;
   pragma Export (C, u00373, "magick_exceptionS");
   u00374 : constant Version_32 := 16#7d87fa07#;
   pragma Export (C, u00374, "magick_pixelB");
   u00375 : constant Version_32 := 16#5e69ed76#;
   pragma Export (C, u00375, "magick_pixelS");
   u00376 : constant Version_32 := 16#db19c26b#;
   pragma Export (C, u00376, "colour_spaceS");
   u00377 : constant Version_32 := 16#e68156d9#;
   pragma Export (C, u00377, "compositeS");
   u00378 : constant Version_32 := 16#094fb960#;
   pragma Export (C, u00378, "compressS");
   u00379 : constant Version_32 := 16#642319d6#;
   pragma Export (C, u00379, "core_blob__apiS");
   u00380 : constant Version_32 := 16#12a77ece#;
   pragma Export (C, u00380, "std_ioS");
   u00381 : constant Version_32 := 16#d2264924#;
   pragma Export (C, u00381, "geometryS");
   u00382 : constant Version_32 := 16#e62db32d#;
   pragma Export (C, u00382, "layerS");
   u00383 : constant Version_32 := 16#95bae204#;
   pragma Export (C, u00383, "magick_profileS");
   u00384 : constant Version_32 := 16#439df4d2#;
   pragma Export (C, u00384, "methodS");
   u00385 : constant Version_32 := 16#cfe9dadb#;
   pragma Export (C, u00385, "monitorS");
   u00386 : constant Version_32 := 16#7d9e2ba3#;
   pragma Export (C, u00386, "quantumS");
   u00387 : constant Version_32 := 16#3b4f34f4#;
   pragma Export (C, u00387, "resampleS");
   u00388 : constant Version_32 := 16#14500f3d#;
   pragma Export (C, u00388, "timerS");
   u00389 : constant Version_32 := 16#ed186219#;
   pragma Export (C, u00389, "magick_imageB");
   u00390 : constant Version_32 := 16#4ab6a8e3#;
   pragma Export (C, u00390, "magick_imageS");
   u00391 : constant Version_32 := 16#45273d41#;
   pragma Export (C, u00391, "magick_image__apiS");
   u00392 : constant Version_32 := 16#df84ea6d#;
   pragma Export (C, u00392, "image_referenceS");
   u00393 : constant Version_32 := 16#948c2841#;
   pragma Export (C, u00393, "magick_optionsS");
   u00394 : constant Version_32 := 16#f4eb32b3#;
   pragma Export (C, u00394, "drawS");
   u00395 : constant Version_32 := 16#ff9d83ad#;
   pragma Export (C, u00395, "quantizeS");
   u00396 : constant Version_32 := 16#7f23b26e#;
   pragma Export (C, u00396, "ogldev_engine_commonS");
   ...
   --  maths%s
   --  maths%b
   --  lighting_technique%s
   --  lighting_technique%b
   --  ogldev_camera%s
   --  ogldev_camera%b
   --  ogldev_math%s
   --  ogldev_math%b
