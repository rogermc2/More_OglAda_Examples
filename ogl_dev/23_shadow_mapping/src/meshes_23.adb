...
package body Meshes_23 is
   ...
   exception
      when others =>
         Put_Line ("An exception occurred in Meshes_23.Init_From_Scene.");
         raise;
            ...
            if Result = Assimp_Types.API_Return_Success then
               if Ogldev_Texture.Init_Texture
                 (aTexture, GL.Low_Level.Enums.Texture_2D,
                  ...
                  Put_Line ("Meshes_23.Init_Materials.Load_Textures loaded texture from "
                            & Dir & To_String (Path));
               else
   ...
   procedure Load_Mesh (theMesh : in out Mesh_23; File_Name : String) is
      theScene : Scene.AI_Scene;
   begin
      theScene :=
   ...
   exception
      when others =>
         Put_Line ("An exception occurred in Meshes_23.Load_Mesh.");
         raise;
   end Load_Mesh;
   ...
   exception
      when others =>
         Put_Line ("An exception occurred in Meshes_23.Render.");
         raise;
   end Render;
