...
procedure Main_Loop (Main_Window :  in out Glfw.Windows.Window) is
   ...
   theLighting_Technique       : Shadow_Map_Technique.Technique;
   Game_Camera                 : Ogldev_Camera.Camera;
   Dir_Light                   : Shadow_Map_Technique.Direct_Light;
   Sphere_Mesh                 : Meshes_23.Mesh_23;
...
--        Target              : constant Singles.Vector3 := (0.0, 0.0, 1.0);  --  Normalized by Camera.Init
   ...
   begin
      ...
      Result := Shadow_Map_Technique.Init (theLighting_Technique);
      if Result then
         Shadow_Map_Technique.Init_Directional_Light (Dir_Light);
         GL.Objects.Programs.Use_Program
           (Shadow_Map_Technique.Light_Program (theLighting_Technique));
         ...
         Meshes_23.Load_Mesh (Sphere_Mesh, "../Content/box.obj");
...
--        GL.Toggles.Enable (GL.Toggles.Vertex_Program_Point_Size);
      ...
      Shadow_Map_Technique.Use_Program (theLighting_Technique);
...
--                                Ogldev_Pipeline.Get_World_Transform (Pipe));
      ...
      Shadow_Map_Technique.Set_WVP (theLighting_Technique,
