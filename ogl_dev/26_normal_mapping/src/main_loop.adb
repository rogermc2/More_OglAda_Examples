...
procedure Main_Loop (Main_Window :  in out Glfw.Windows.Window) is
   ...
   procedure Update_Bump_State (Window : in out Glfw.Windows.Window);
   ...
   procedure Update_Bump_State (Window : in out Glfw.Windows.Window) is
      use Glfw.Input;
   begin
      if Window'Access.Key_State (Keys.B) = Pressed then
         Bump_Map_Enabled := not Bump_Map_Enabled;
      end if;
   end Update_Bump_State;
