...
package body Lighting_Technique_21 is 
    ...
    begin
        ...
        for index in GL.Types.Int range Lights'First .. Lights'Last loop
            ...
            GL.Uniforms.Set_Single 
              (theTechnique.Spot_Lights_Locations (index).Ambient_Intensity,
               Lights (index).Point.Base.Ambient_Intensity);
            GL.Uniforms.Set_Single 
              (theTechnique.Spot_Lights_Locations (index).Diffuse_Intensity,
            ...
            GL.Uniforms.Set_Single 
              (theTechnique.Spot_Lights_Locations (index).Direction,
            ...
            GL.Uniforms.Set_Single 
              (theTechnique.Spot_Lights_Locations (index).Atten.Constant_Atten,
               Lights (index).Point.Atten.Constant_Atten);
            GL.Uniforms.Set_Single 
              (theTechnique.Spot_Lights_Locations (index).Atten.Linear,
               Lights (index).Point.Atten.Linear);
            GL.Uniforms.Set_Single 
              (theTechnique.Spot_Lights_Locations (index).Atten.Exp,
    ...
    begin
        if GL.Objects.Programs.Link_Status (theTechnique.Lighting_Program) then
            ...
            Put_Line ("Lighting_Technique_21.Use_Program, Lighting_Program link check failed");      
        end if;
