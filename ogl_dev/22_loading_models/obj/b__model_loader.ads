...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_model_loader" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#16da144c#;
   pragma Export (C, u00001, "model_loaderB");
   ...
   u00312 : constant Version_32 := 16#7c71e763#;
   pragma Export (C, u00312, "ogldev_basic_lightingB");
   u00313 : constant Version_32 := 16#26600bbd#;
   pragma Export (C, u00313, "ogldev_basic_lightingS");
   u00314 : constant Version_32 := 16#8364a88f#;
   pragma Export (C, u00314, "program_loaderB");
   u00315 : constant Version_32 := 16#25171948#;
   pragma Export (C, u00315, "program_loaderS");
   u00316 : constant Version_32 := 16#e6195f7f#;
   pragma Export (C, u00316, "ada__directoriesB");
   u00317 : constant Version_32 := 16#9da5f6a3#;
   pragma Export (C, u00317, "ada__directoriesS");
   u00318 : constant Version_32 := 16#b8719323#;
   pragma Export (C, u00318, "ada__calendarB");
   u00319 : constant Version_32 := 16#41508869#;
   pragma Export (C, u00319, "ada__calendarS");
   u00320 : constant Version_32 := 16#95569f93#;
   pragma Export (C, u00320, "ada__calendar__formattingB");
   u00321 : constant Version_32 := 16#7ddaf16f#;
   pragma Export (C, u00321, "ada__calendar__formattingS");
   u00322 : constant Version_32 := 16#e3cca715#;
   pragma Export (C, u00322, "ada__calendar__time_zonesB");
   u00323 : constant Version_32 := 16#77b56b93#;
   pragma Export (C, u00323, "ada__calendar__time_zonesS");
   ...
   u00328 : constant Version_32 := 16#c2ca0511#;
   pragma Export (C, u00328, "system__val_realB");
   u00329 : constant Version_32 := 16#f67218ea#;
   pragma Export (C, u00329, "system__val_realS");
   u00330 : constant Version_32 := 16#8f637df8#;
   pragma Export (C, u00330, "ada__characters__handlingB");
   u00331 : constant Version_32 := 16#3b3f6154#;
   pragma Export (C, u00331, "ada__characters__handlingS");
   u00332 : constant Version_32 := 16#92f05f13#;
   pragma Export (C, u00332, "ada__strings__maps__constantsS");
   u00333 : constant Version_32 := 16#ab4ad33a#;
   pragma Export (C, u00333, "ada__directories__validityB");
   u00334 : constant Version_32 := 16#498b13d5#;
   pragma Export (C, u00334, "ada__directories__validityS");
   u00335 : constant Version_32 := 16#2f6496d9#;
   pragma Export (C, u00335, "system__file_attributesS");
   u00336 : constant Version_32 := 16#95f86c43#;
   pragma Export (C, u00336, "system__regexpB");
   u00337 : constant Version_32 := 16#2b69c837#;
   pragma Export (C, u00337, "system__regexpS");
   u00338 : constant Version_32 := 16#f1013930#;
   pragma Export (C, u00338, "gl__filesB");
   u00339 : constant Version_32 := 16#07708aff#;
   pragma Export (C, u00339, "gl__filesS");
   u00340 : constant Version_32 := 16#0460865d#;
   pragma Export (C, u00340, "system__direct_ioB");
   u00341 : constant Version_32 := 16#aa3a89c5#;
   pragma Export (C, u00341, "system__direct_ioS");
   u00342 : constant Version_32 := 16#049f8d78#;
   pragma Export (C, u00342, "ant_tweak_barS");
   u00343 : constant Version_32 := 16#7f23b26e#;
   pragma Export (C, u00343, "ogldev_engine_commonS");
   u00344 : constant Version_32 := 16#76d52b62#;
   pragma Export (C, u00344, "ogldev_lights_commonB");
   u00345 : constant Version_32 := 16#bb03f22f#;
   pragma Export (C, u00345, "ogldev_lights_commonS");
   u00346 : constant Version_32 := 16#5f4dfa6b#;
   pragma Export (C, u00346, "ogldev_cameraB");
   u00347 : constant Version_32 := 16#1d4e16a1#;
   pragma Export (C, u00347, "ogldev_cameraS");
   u00348 : constant Version_32 := 16#69a39772#;
   pragma Export (C, u00348, "ogldev_mathB");
   u00349 : constant Version_32 := 16#54efce40#;
   pragma Export (C, u00349, "ogldev_mathS");
   u00350 : constant Version_32 := 16#8225628b#;
   pragma Export (C, u00350, "ada__containers__red_black_treesS");
   u00351 : constant Version_32 := 16#97484436#;
   pragma Export (C, u00351, "api_vectors_matricesS");
   u00352 : constant Version_32 := 16#795a09a8#;
   pragma Export (C, u00352, "assimp_typesS");
   u00353 : constant Version_32 := 16#45e248ec#;
   pragma Export (C, u00353, "ogldev_pipelineB");
   u00354 : constant Version_32 := 16#fda84fc1#;
   pragma Export (C, u00354, "ogldev_pipelineS");
   u00355 : constant Version_32 := 16#e2db7a97#;
   pragma Export (C, u00355, "ogldev_textureB");
   u00356 : constant Version_32 := 16#8be1add2#;
   pragma Export (C, u00356, "ogldev_textureS");
   u00357 : constant Version_32 := 16#622ef959#;
   pragma Export (C, u00357, "magick_blobB");
   u00358 : constant Version_32 := 16#4b00bb5e#;
   pragma Export (C, u00358, "magick_blobS");
   u00359 : constant Version_32 := 16#3bd4d6c1#;
   pragma Export (C, u00359, "magick_blob__apiS");
   u00360 : constant Version_32 := 16#95bf520f#;
   pragma Export (C, u00360, "blob_referenceS");
   u00361 : constant Version_32 := 16#8bfaf470#;
   pragma Export (C, u00361, "core_blobB");
   u00362 : constant Version_32 := 16#d1053d88#;
   pragma Export (C, u00362, "core_blobS");
   u00363 : constant Version_32 := 16#dbe9ed6e#;
   pragma Export (C, u00363, "magick_typeB");
   u00364 : constant Version_32 := 16#7785c8f7#;
   pragma Export (C, u00364, "magick_typeS");
   u00365 : constant Version_32 := 16#35df64f0#;
   pragma Export (C, u00365, "method_attributeS");
   u00366 : constant Version_32 := 16#53ad6155#;
   pragma Export (C, u00366, "semaphoreS");
   u00367 : constant Version_32 := 16#49b21dba#;
   pragma Export (C, u00367, "threadS");
   u00368 : constant Version_32 := 16#d389491e#;
   pragma Export (C, u00368, "sys_pthread_mutexS");
   u00369 : constant Version_32 := 16#69226a62#;
   pragma Export (C, u00369, "sys_pthread_typesS");
   u00370 : constant Version_32 := 16#78534528#;
   pragma Export (C, u00370, "streamS");
   u00371 : constant Version_32 := 16#f6d2357a#;
   pragma Export (C, u00371, "core_imageB");
   u00372 : constant Version_32 := 16#9cd5aa63#;
   pragma Export (C, u00372, "core_imageS");
   u00373 : constant Version_32 := 16#22ecdf37#;
   pragma Export (C, u00373, "cacheS");
   u00374 : constant Version_32 := 16#87ef8a9e#;
   pragma Export (C, u00374, "colourS");
   u00375 : constant Version_32 := 16#f63ada63#;
   pragma Export (C, u00375, "magick_exceptionB");
   u00376 : constant Version_32 := 16#5ac5357b#;
   pragma Export (C, u00376, "magick_exceptionS");
   u00377 : constant Version_32 := 16#7d87fa07#;
   pragma Export (C, u00377, "magick_pixelB");
   u00378 : constant Version_32 := 16#5e69ed76#;
   pragma Export (C, u00378, "magick_pixelS");
   u00379 : constant Version_32 := 16#db19c26b#;
   pragma Export (C, u00379, "colour_spaceS");
   u00380 : constant Version_32 := 16#e68156d9#;
   pragma Export (C, u00380, "compositeS");
   u00381 : constant Version_32 := 16#094fb960#;
   pragma Export (C, u00381, "compressS");
   u00382 : constant Version_32 := 16#642319d6#;
   pragma Export (C, u00382, "core_blob__apiS");
   u00383 : constant Version_32 := 16#12a77ece#;
   pragma Export (C, u00383, "std_ioS");
   u00384 : constant Version_32 := 16#d2264924#;
   pragma Export (C, u00384, "geometryS");
   u00385 : constant Version_32 := 16#e62db32d#;
   pragma Export (C, u00385, "layerS");
   u00386 : constant Version_32 := 16#95bae204#;
   pragma Export (C, u00386, "magick_profileS");
   u00387 : constant Version_32 := 16#439df4d2#;
   pragma Export (C, u00387, "methodS");
   u00388 : constant Version_32 := 16#cfe9dadb#;
   pragma Export (C, u00388, "monitorS");
   u00389 : constant Version_32 := 16#7d9e2ba3#;
   pragma Export (C, u00389, "quantumS");
   u00390 : constant Version_32 := 16#3b4f34f4#;
   pragma Export (C, u00390, "resampleS");
   u00391 : constant Version_32 := 16#14500f3d#;
   pragma Export (C, u00391, "timerS");
   u00392 : constant Version_32 := 16#ed186219#;
   pragma Export (C, u00392, "magick_imageB");
   u00393 : constant Version_32 := 16#4ab6a8e3#;
   pragma Export (C, u00393, "magick_imageS");
   u00394 : constant Version_32 := 16#45273d41#;
   pragma Export (C, u00394, "magick_image__apiS");
   u00395 : constant Version_32 := 16#df84ea6d#;
   pragma Export (C, u00395, "image_referenceS");
   u00396 : constant Version_32 := 16#948c2841#;
   pragma Export (C, u00396, "magick_optionsS");
   u00397 : constant Version_32 := 16#f4eb32b3#;
   pragma Export (C, u00397, "drawS");
   u00398 : constant Version_32 := 16#ff9d83ad#;
   pragma Export (C, u00398, "quantizeS");
   ...
   --  ogldev_lights_common%s
   --  ogldev_lights_common%b
   --  program_loader%s
   --  program_loader%b
   --  quantize%s
   --  quaternions%s
   ...
   --  maths%s
   --  maths%b
   --  ogldev_basic_lighting%s
   --  ogldev_basic_lighting%b
   --  ogldev_camera%s
   --  ogldev_camera%b
   --  ogldev_math%s
   --  ogldev_math%b
