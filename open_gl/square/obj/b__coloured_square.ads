...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_coloured_square" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#1e7fc6e6#;
   pragma Export (C, u00001, "coloured_squareB");
   ...
   u00257 : constant Version_32 := 16#aee7147a#;
   ...
   u00261 : constant Version_32 := 16#185e2091#;
   pragma Export (C, u00261, "program_loaderB");
   u00262 : constant Version_32 := 16#bd70322f#;
   pragma Export (C, u00262, "program_loaderS");
   u00263 : constant Version_32 := 16#e6195f7f#;
   pragma Export (C, u00263, "ada__directoriesB");
   u00264 : constant Version_32 := 16#9da5f6a3#;
   pragma Export (C, u00264, "ada__directoriesS");
   ...
   u00269 : constant Version_32 := 16#95569f93#;
   pragma Export (C, u00269, "ada__calendar__formattingB");
   u00270 : constant Version_32 := 16#7ddaf16f#;
   pragma Export (C, u00270, "ada__calendar__formattingS");
   u00271 : constant Version_32 := 16#e3cca715#;
   pragma Export (C, u00271, "ada__calendar__time_zonesB");
   u00272 : constant Version_32 := 16#77b56b93#;
   pragma Export (C, u00272, "ada__calendar__time_zonesS");
   u00273 : constant Version_32 := 16#d763507a#;
   pragma Export (C, u00273, "system__val_intB");
   u00274 : constant Version_32 := 16#40fe45c4#;
   pragma Export (C, u00274, "system__val_intS");
   u00275 : constant Version_32 := 16#1d9142a4#;
   pragma Export (C, u00275, "system__val_unsB");
   u00276 : constant Version_32 := 16#2c75fe43#;
   pragma Export (C, u00276, "system__val_unsS");
   u00277 : constant Version_32 := 16#c2ca0511#;
   pragma Export (C, u00277, "system__val_realB");
   u00278 : constant Version_32 := 16#f67218ea#;
   pragma Export (C, u00278, "system__val_realS");
   u00279 : constant Version_32 := 16#8f637df8#;
   pragma Export (C, u00279, "ada__characters__handlingB");
   u00280 : constant Version_32 := 16#3b3f6154#;
   pragma Export (C, u00280, "ada__characters__handlingS");
   u00281 : constant Version_32 := 16#92f05f13#;
   pragma Export (C, u00281, "ada__strings__maps__constantsS");
   u00282 : constant Version_32 := 16#ab4ad33a#;
   pragma Export (C, u00282, "ada__directories__validityB");
   u00283 : constant Version_32 := 16#498b13d5#;
   pragma Export (C, u00283, "ada__directories__validityS");
   u00284 : constant Version_32 := 16#2f6496d9#;
   ...
   u00286 : constant Version_32 := 16#95f86c43#;
   pragma Export (C, u00286, "system__regexpB");
   u00287 : constant Version_32 := 16#2b69c837#;
   pragma Export (C, u00287, "system__regexpS");
   u00288 : constant Version_32 := 16#06e78f59#;
   pragma Export (C, u00288, "gl__filesB");
   u00289 : constant Version_32 := 16#07708aff#;
   pragma Export (C, u00289, "gl__filesS");
   u00290 : constant Version_32 := 16#0460865d#;
   pragma Export (C, u00290, "system__direct_ioB");
   u00291 : constant Version_32 := 16#aa3a89c5#;
   pragma Export (C, u00291, "system__direct_ioS");
   u00292 : constant Version_32 := 16#f4fc5225#;
   pragma Export (C, u00292, "vertex_dataS");
