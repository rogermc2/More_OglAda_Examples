pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__coloured_square.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__coloured_square.adb");
...
package body ada_main is
   ...
   E292 : Short_Integer; pragma Import (Ada, E292, "vertex_data_E");
   ...
   begin
      ...
      E216 := E216 + 1;
      E212 := E212 + 1;
      Vertex_Data'Elab_Spec;
      E292 := E292 + 1;
      E258 := E258 + 1;
   end adainit;

   procedure Ada_Main_Program;
   pragma Import (Ada, Ada_Main_Program, "_ada_coloured_square");
...
--  BEGIN Object file/option list
   --   /Ada_Source/OpenGLAda/examples/open_gl/square/obj/vertex_data.o
   --   /Ada_Source/OpenGLAda/examples/open_gl/square/obj/main_loop.o
   --   /Ada_Source/OpenGLAda/examples/open_gl/square/obj/coloured_square.o
   --   -L/Ada_Source/OpenGLAda/examples/open_gl/square/obj/
   --   -L/Ada_Source/OpenGLAda/examples/open_gl/square/obj/
