pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__uniform_example.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__uniform_example.adb");
...
package body ada_main is
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_uniform_example");
...
--  BEGIN Object file/option list
   --   /Ada_Source/OpenGLAda/examples/open_gl/simple_uniform/obj/vertex_data.o
   --   /Ada_Source/OpenGLAda/examples/open_gl/simple_uniform/obj/main_loop.o
   --   /Ada_Source/OpenGLAda/examples/open_gl/simple_uniform/obj/uniform_example.o
   --   -L/Ada_Source/OpenGLAda/examples/open_gl/simple_uniform/obj/
   --   -L/Ada_Source/OpenGLAda/examples/open_gl/simple_uniform/obj/
