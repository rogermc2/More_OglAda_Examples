pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__triangle.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__triangle.adb");
...
package body ada_main is
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_triangle");
...
--  BEGIN Object file/option list
   --   /Ada_Source/OpenGLAda/examples/open_gl/very_simple/obj/vertex_data.o
   --   /Ada_Source/OpenGLAda/examples/open_gl/very_simple/obj/main_loop.o
   --   /Ada_Source/OpenGLAda/examples/open_gl/very_simple/obj/triangle.o
   --   -L/Ada_Source/OpenGLAda/examples/open_gl/very_simple/obj/
   --   -L/Ada_Source/OpenGLAda/examples/open_gl/very_simple/obj/
