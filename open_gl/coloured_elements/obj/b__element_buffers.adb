pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__element_buffers.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__element_buffers.adb");
...
package body ada_main is
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_element_buffers");
...
--  BEGIN Object file/option list
   --   /Ada_Source/OpenGLAda/examples/open_gl/coloured_elements/obj/vertex_data.o
   --   /Ada_Source/OpenGLAda/examples/open_gl/coloured_elements/obj/main_loop.o
   --   /Ada_Source/OpenGLAda/examples/open_gl/coloured_elements/obj/element_buffers.o
   --   -L/Ada_Source/OpenGLAda/examples/open_gl/coloured_elements/obj/
   --   -L/Ada_Source/OpenGLAda/examples/open_gl/coloured_elements/obj/
