...
package body FB_Default_Shader_Manager is
   ...
   begin
      Shader_Program := Program_From
        ((Src ("src/shaders_3_2/fb_default.vert", Vertex_Shader),
         Src ("src/shaders_3_2/fb_default.frag", Fragment_Shader)));
   ...
   exception
      when others =>
         Put_Line ("An exception occurred in FB_Default_Shader_Manager.Init.");
         raise;
   end Init;
