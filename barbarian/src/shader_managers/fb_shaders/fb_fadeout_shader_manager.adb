...
package body FB_Fadeout_Shader_Manager is
   ...
   begin
      Shader_Program := Program_From
        ((Src ("src/shaders_3_2/fb_fadeout.vert", Vertex_Shader),
         Src ("src/shaders_3_2/fb_fadeout.frag", Fragment_Shader)));
   ...
   exception
      when others =>
         Put_Line ("An exception occurred in FB_Fadeout_Shader_Manager.Init.");
         raise;
   end Init;
