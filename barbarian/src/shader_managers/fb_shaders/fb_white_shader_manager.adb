...
package body FB_White_Shader_Manager is
   ...
   begin
      Shader_Program := Program_From
        ((Src ("src/shaders_3_2/fb_white.vert", Vertex_Shader),
         Src ("src/shaders_3_2/fb_white.frag", Fragment_Shader)));
   ...
   exception
      when others =>
         Put_Line ("An exception occurred in FB_White_Shader_Manager.Init.");
         raise;
   end Init;
