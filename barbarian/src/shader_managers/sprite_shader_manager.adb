...
package body Sprite_Shader_Manager is
   ...
   Vec2_Init         : constant GL.Types.Ints.Vector2 := (0, 0);
   ...
   procedure Init_Sprite_Shaders is
   ...
   begin
      ...
      GL.Uniforms.Set_Int (Sprite_Uniform.Cube_Texture_ID, 3);
      GL.Uniforms.Set_Single (Sprite_Uniform.Current_Sprite_ID, 0.0);
      GL.Uniforms.Set_Int (Sprite_Uniform.Diff_Map_ID, 0);
      ...
      GL.Uniforms.Set_Int (Sprite_Uniform.Spec_Map_ID, 1);
      GL.Uniforms.Set_Int (Sprite_Uniform.Static_Light_Indices_ID, Vec2_Init);
      GL.Uniforms.Set_Single (Sprite_Uniform.View_ID, Identity4);

   exception
      when others =>
         Put_Line ("An exception occurred in Properties_Shader_Manager.Load_Sprite_Shaders.");
         raise;
   ...
   begin
      GL.Uniforms.Set_Int (Sprite_Uniform.Cube_Texture_ID, Texture);
   ...
   begin
      GL.Uniforms.Set_Int (Sprite_Uniform.Diff_Map_ID, Diff_Map);
   end Set_Diff_Map;
   ...
   begin
      GL.Uniforms.Set_Int (Sprite_Uniform.Spec_Map_ID, Spec_Map);
   end Set_Spec_Map;
   ...
   begin
      GL.Uniforms.Set_Int (Sprite_Uniform.Static_Light_Indices_ID, Indices);
