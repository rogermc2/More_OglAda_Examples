...
package body Depth_Skinned_Shader_Manager is
   ...
   begin
      ...
      Render_Uniforms.Bone_Matrices_ID :=
          Uniform_Location (Shader_Program, "bone_matrices");
  ...
  --  -------------------------------------------------------------------------
    ...
    procedure Set_Bone_Matrices (Bone_Matrices : Bone_Matrices_Array) is
   begin
      GL.Uniforms.Set_Single (Render_Uniforms.Bone_Matrices_ID, Bone_Matrices);
