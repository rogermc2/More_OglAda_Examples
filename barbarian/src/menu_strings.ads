...
package Menu_Strings is
    ...
    type Graphic_Choice_Type is
      (Graphic_Presets, Graphic_Opengl_Version, Graphic_Windowed_Size,
       ...
       Graphic_Anisotropy, Graphic_Msaa, Graphic_Ssaa, Graphic_Render_Dist,
       Graphic_Far_Clip, Graphic_Auto_Blood_Wipe, Graphic_Show_Fps);
    pragma Ordered (Graphic_Choice_Type);
    type Enabled_Strings_Choice_Type is
      (Graphic_Strings_Enabled, Graphic_Strings_Disabled);
    pragma Ordered (Enabled_Strings_Choice_Type);
    type Texture_Filter_Choice_Type is
      (Texture_Filter_Nearest, Texture_Filter_Bilinear, Texture_Filter_Trilinear);
    pragma Ordered (Texture_Filter_Choice_Type);
    ...
    type Graphic_Menu_Array is array (Graphic_Choice_Type'Range)
      of String (1 .. 16);
    type Enabled_Strings_Array is array (Enabled_Strings_Choice_Type'Range)
      of String (1 .. 8);
    type Texture_Filter_Strings_Array is array (Texture_Filter_Choice_Type'Range)
      of String (1 .. 9);
    ...
    Enabled_Strings     : constant Enabled_Strings_Array :=
                            ("disabled",
                             "enabled ");
    Texture_Filter_Strings : constant Texture_Filter_Strings_Array :=
                               ("nearest  ",
                                "bilinear ",
                                "trilinear");
