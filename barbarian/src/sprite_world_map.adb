...
package body Sprite_World_Map is
    ...
    begin
        for row in 1 .. Sprite_Index (Tiles_Manager.Max_Map_Rows) loop
            for col in 1 .. Sprite_Index (Tiles_Manager.Max_Map_Cols) loop
    ...
    procedure Init is
        ...
        New_Sprite_Tiles : Sprite_Tiles_Data
          (Sprite_Index (Max_Map_Cols), Sprite_Index (Max_Map_Cols),
           Max_Sprites_In_Tile);
    begin
        if Max_Map_Rows <= 0 or Max_Map_Cols <= 0 or
