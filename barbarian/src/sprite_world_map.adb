...
package body Sprite_World_Map is
   ...
   type Sprite_Tiles_Data is record
      Index_Of_Sprites            : Sprites_Integer_Array
        (1 .. Tiles_Manager.Max_Tile_Cols, 1 .. Tiles_Manager.Max_Tile_Cols,
         1 .. Max_Sprites_In_Tile) :=(others => (others => (others => 0)));
      Height_Of_Sprites           : Sprites_Single_Array
        (1 .. Tiles_Manager.Max_Tile_Cols, 1 .. Tiles_Manager.Max_Tile_Cols,
         1 .. Max_Sprites_In_Tile) := (others => (others => (others => (0.0))));
      Count_Of_Sprites_In_Tiles   : Sprites_Count_Array
        (1 .. Tiles_Manager.Max_Tile_Cols, 1 .. Tiles_Manager.Max_Tile_Cols)
        := (others => (others => 0));
   end record;
   ...
   begin
      for row in 1 .. Sprite_Index (Tiles_Manager.Max_Tile_Cols) loop
         for col in 1 .. Sprite_Index (Tiles_Manager.Max_Tile_Cols) loop
            Sprite_Tiles.Count_Of_Sprites_In_Tiles (row, col) := 0;
            for sprite in Sprite_Index range
              1 .. Sprite_Index (Max_Sprites_In_Tile) loop
