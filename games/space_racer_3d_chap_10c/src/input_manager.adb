...
package body Input_Manager is
    ...
    use Sprite_Manager;
    GUI_Elements    : array (Button_Index range Button_Index'Range) of
    ...
    function Check_For_Click (Window      : in out Input_Callback.Callback_Window;
                              GUI_Element : Sprite) return Boolean is
        use Glfw.Input;
        use Input_Callback;
        ...
        Position       : constant Point := Get_Position (GUI_Element);
    ...
    begin
        if Is_Button_Down (Glfw.Input.Mouse.Left_Button) then
            ...
            Result := Cursor_X >= Left and
              Cursor_X <= Left + Get_Width (GUI_Element) and
              Cursor_Y >= Bottom and
              Cursor_Y <=  Bottom + Get_Height (GUI_Element);
        end if;
        return Result;
    end Check_For_Click;
    ...
    begin
        ...
        Set_Frame_Size (GUI_Elements (Pause_Button), B_Height, B_Width);
        Set_Number_Of_Frames (GUI_Elements (Pause_Button), 1);
        Set_Position (GUI_Elements (Pause_Button), 10.0, 10.0);
        Add_Texture (GUI_Elements
                     (Pause_Button), "src/resources/pauseButton.png", False);
        Set_Visible (GUI_Elements (Pause_Button), True);
        Set_Active (GUI_Elements (Pause_Button), True);

        Set_Frame_Size (GUI_Elements (Resume_Button), B_Height, B_Width);
        Set_Number_Of_Frames (GUI_Elements (Resume_Button), 1);
        Set_Position (GUI_Elements (Resume_Button), 80.0, 10.0);
        Add_Texture (GUI_Elements
                     (Resume_Button), "src/resources/resumeButton.png", False);

        Set_Frame_Size (GUI_Elements (Play_Button), B_Height, B_Width);
        Set_Number_Of_Frames (GUI_Elements (Play_Button), 1);
        Set_Position (GUI_Elements (Play_Button), 390.0, S_Height - 350.0);
        Set_Visible (GUI_Elements (Play_Button), True);
        Add_Texture (GUI_Elements
                     (Play_Button), "src/resources/playButton.png", False);

        Set_Frame_Size (GUI_Elements (Credits_Button), B_Height, B_Width);
        Set_Number_Of_Frames (GUI_Elements (Credits_Button), 1);
        Set_Position (GUI_Elements (Credits_Button), 390.0, S_Height - 400.0);
        Set_Visible (GUI_Elements (Credits_Button), True);
        Add_Texture (GUI_Elements
                     (Credits_Button), "src/resources/creditsButton.png", False);

        Set_Frame_Size (GUI_Elements (Exit_Button), B_Height, B_Width);
        Set_Number_Of_Frames (GUI_Elements (Exit_Button), 1);
        Set_Position (GUI_Elements (Exit_Button), 390.0, 40.0);
        Set_Visible (GUI_Elements (Exit_Button), True);
        Add_Texture (GUI_Elements
                     (Exit_Button), "src/resources/exitButton.png", False);

        Set_Frame_Size (GUI_Elements (Menu_Button), B_Height, B_Width);
        Set_Number_Of_Frames (GUI_Elements (Menu_Button), 1);
        Set_Position (GUI_Elements (Menu_Button), 390.0, S_Height - 450.0);
        Set_Visible (GUI_Elements (Menu_Button), True);
        Add_Texture (GUI_Elements
                     (Menu_Button), "src/resources/menuButton.png", False);

        Set_Frame_Size (GUI_Elements (Continue_Button), B_Height, B_Width);
        Set_Number_Of_Frames (GUI_Elements (Continue_Button), 1);
        Set_Position (GUI_Elements (Continue_Button), 390.0, S_Height - 400.0);
        Set_Visible (GUI_Elements (Continue_Button), True);
        Add_Texture (GUI_Elements
                     (Continue_Button), "src/resources/continueButton.png", False);


        Set_Frame_Size (GUI_Elements (Replay_Button), B_Height, B_Width);
        Set_Number_Of_Frames (GUI_Elements (Replay_Button), 1);
        Set_Position (GUI_Elements (Replay_Button), 390.0, 90.0);
        Set_Visible (GUI_Elements (Replay_Button), True);
        Add_Texture (GUI_Elements
    ...
    begin
        return Sprite_Manager.Is_Active (GUI_Elements (Button));
    end Is_Active;
    ...
    begin
        return Sprite_Manager.Is_Clicked (GUI_Elements (Button));
    end Is_Clicked;
    ...
    begin
        return Sprite_Manager.Is_Visible (GUI_Elements (Button));
    end Is_Visible;
    ...
    begin
        ...
        Sprite_Manager.Render (GUI_Elements (Button));
    end Render_Button;
    ...
    begin
        Sprite_Manager.Set_Active (GUI_Elements (Button), State);
    end Set_Active;
    ...
    begin
        Sprite_Manager.Set_Visible (GUI_Elements (Button), State);
    end Set_Visible;
    ...
    begin
        Sprite_Manager.Set_Clicked (GUI_Elements (Button), Clicked);
    end Set_Clicked;
...
--      end Update;
    ...
    procedure Update_Command (Window : in out Input_Callback.Callback_Window) is
        ...
        begin
            if Is_Active (GUI_Elements (Index)) then
                if Check_For_Click (Window, GUI_Elements (Index)) then
                    Set_Clicked (GUI_Elements (Index), True);
