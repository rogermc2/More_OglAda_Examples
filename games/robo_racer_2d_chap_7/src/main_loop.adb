...
procedure Main_Loop (Main_Window : in out Input_Callback.Callback_Window) is
    ...
    begin
        ...
        if Intersect_Circle (Player, Pickup) then
            Audio_Manager.Play_Sound (Audio_Manager.Oilcan_Sound);
        ...
        if Intersect_Rectangle (Player, Enemy) then
            Audio_Manager.Play_Sound (Audio_Manager.Water_Sound);
    ...
    begin
        ...
        if Continue then
            ...
            when Command_Up =>
                Audio_Manager.Play_Sound (Audio_Manager.Jump_Sound);
                Jump (Player, Sprite_Up);
            when Command_Down =>
                Audio_Manager.Play_Sound (Audio_Manager.Jump_Sound);
                Jump (Player, Sprite_Down);
