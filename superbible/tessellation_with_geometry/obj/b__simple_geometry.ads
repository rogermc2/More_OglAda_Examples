...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_simple_geometry" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#3e82e6ed#;
   pragma Export (C, u00001, "simple_geometryB");
   ...
   u00257 : constant Version_32 := 16#892d32bc#;
