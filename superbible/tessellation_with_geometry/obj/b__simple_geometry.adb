pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__simple_geometry.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__simple_geometry.adb");
...
package body ada_main is
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_simple_geometry");
...
--  BEGIN Object file/option list
   --   /Ada_Source/OpenGLAda/examples/superbible/tessellation_with_geometry/obj/main_loop.o
   --   /Ada_Source/OpenGLAda/examples/superbible/tessellation_with_geometry/obj/simple_geometry.o
   --   -L/Ada_Source/OpenGLAda/examples/superbible/tessellation_with_geometry/obj/
   --   -L/Ada_Source/OpenGLAda/examples/superbible/tessellation_with_geometry/obj/
