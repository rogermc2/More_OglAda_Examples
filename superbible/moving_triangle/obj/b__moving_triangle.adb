pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__moving_triangle.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__moving_triangle.adb");
...
package body ada_main is
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_moving_triangle");
...
--  BEGIN Object file/option list
   --   /Ada_Source/OpenGLAda/examples/superbible/moving_triangle/obj/main_loop.o
   --   /Ada_Source/OpenGLAda/examples/superbible/moving_triangle/obj/moving_triangle.o
   --   -L/Ada_Source/OpenGLAda/examples/superbible/moving_triangle/obj/
   --   -L/Ada_Source/OpenGLAda/examples/superbible/moving_triangle/obj/
