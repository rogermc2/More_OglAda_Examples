...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_moving_triangle" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#5ed13a6c#;
   pragma Export (C, u00001, "moving_triangleB");
   ...
   u00257 : constant Version_32 := 16#5d937cbb#;
