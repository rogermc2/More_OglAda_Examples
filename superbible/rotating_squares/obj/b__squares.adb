pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__squares.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__squares.adb");
...
package body ada_main is
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_squares");
...
--  BEGIN Object file/option list
   --   /Ada_Source/OpenGLAda/examples/superbible/rotating_squares/obj/vertex_data.o
   --   /Ada_Source/OpenGLAda/examples/superbible/rotating_squares/obj/main_loop.o
   --   /Ada_Source/OpenGLAda/examples/superbible/rotating_squares/obj/squares.o
   --   -L/Ada_Source/OpenGLAda/examples/superbible/rotating_squares/obj/
   --   -L/Ada_Source/OpenGLAda/examples/superbible/rotating_squares/obj/
