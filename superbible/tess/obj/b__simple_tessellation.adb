pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__simple_tessellation.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__simple_tessellation.adb");
...
package body ada_main is
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_simple_tessellation");
...
--  BEGIN Object file/option list
   --   /Ada_Source/OpenGLAda/examples/superbible/tess/obj/main_loop.o
   --   /Ada_Source/OpenGLAda/examples/superbible/tess/obj/simple_tessellation.o
   --   -L/Ada_Source/OpenGLAda/examples/superbible/tess/obj/
   --   -L/Ada_Source/OpenGLAda/examples/superbible/tess/obj/
