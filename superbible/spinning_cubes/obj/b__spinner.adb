pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__spinner.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__spinner.adb");
...
package body ada_main is
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_spinner");
...
--  BEGIN Object file/option list
   --   /Ada_Source/OpenGLAda/examples/superbible/spinning_cubes/obj/vertex_data.o
   --   /Ada_Source/OpenGLAda/examples/superbible/spinning_cubes/obj/main_loop.o
   --   /Ada_Source/OpenGLAda/examples/superbible/spinning_cubes/obj/spinner.o
   --   -L/Ada_Source/OpenGLAda/examples/superbible/spinning_cubes/obj/
   --   -L/Ada_Source/OpenGLAda/examples/superbible/spinning_cubes/obj/
