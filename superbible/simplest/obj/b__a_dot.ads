...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_a_dot" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#11f1d321#;
   pragma Export (C, u00001, "a_dotB");
   ...
   u00219 : constant Version_32 := 16#fa7660ff#;
   pragma Export (C, u00219, "utilitiesB");
   u00220 : constant Version_32 := 16#088f8d11#;
   ...
   u00254 : constant Version_32 := 16#6a8b4fed#;
   pragma Export (C, u00254, "mathsB");
   u00255 : constant Version_32 := 16#5cf048da#;
   ...
   u00260 : constant Version_32 := 16#9d99814b#;
   pragma Export (C, u00260, "quaternionsB");
   u00261 : constant Version_32 := 16#307d565a#;
   ...
   u00273 : constant Version_32 := 16#a5038496#;
   pragma Export (C, u00273, "main_loopB");
   u00274 : constant Version_32 := 16#bdd35137#;
   pragma Export (C, u00274, "main_loopS");
   u00275 : constant Version_32 := 16#aa9a2958#;
   pragma Export (C, u00275, "gl__objects__vertex_arraysB");
   u00276 : constant Version_32 := 16#1d5a67ec#;
   pragma Export (C, u00276, "gl__objects__vertex_arraysS");
   u00277 : constant Version_32 := 16#8364a88f#;
   pragma Export (C, u00277, "program_loaderB");
   u00278 : constant Version_32 := 16#25171948#;
   pragma Export (C, u00278, "program_loaderS");
   u00279 : constant Version_32 := 16#e6195f7f#;
   pragma Export (C, u00279, "ada__directoriesB");
   u00280 : constant Version_32 := 16#9da5f6a3#;
   pragma Export (C, u00280, "ada__directoriesS");
   u00281 : constant Version_32 := 16#b8719323#;
   pragma Export (C, u00281, "ada__calendarB");
   u00282 : constant Version_32 := 16#41508869#;
   pragma Export (C, u00282, "ada__calendarS");
   u00283 : constant Version_32 := 16#2b2125d3#;
   pragma Export (C, u00283, "system__os_primitivesB");
   u00284 : constant Version_32 := 16#0fa60a0d#;
   pragma Export (C, u00284, "system__os_primitivesS");
   u00285 : constant Version_32 := 16#95569f93#;
   pragma Export (C, u00285, "ada__calendar__formattingB");
   u00286 : constant Version_32 := 16#7ddaf16f#;
   pragma Export (C, u00286, "ada__calendar__formattingS");
   u00287 : constant Version_32 := 16#e3cca715#;
   pragma Export (C, u00287, "ada__calendar__time_zonesB");
   u00288 : constant Version_32 := 16#77b56b93#;
   pragma Export (C, u00288, "ada__calendar__time_zonesS");
   u00289 : constant Version_32 := 16#d763507a#;
   pragma Export (C, u00289, "system__val_intB");
   u00290 : constant Version_32 := 16#40fe45c4#;
   pragma Export (C, u00290, "system__val_intS");
   u00291 : constant Version_32 := 16#1d9142a4#;
   pragma Export (C, u00291, "system__val_unsB");
   u00292 : constant Version_32 := 16#2c75fe43#;
   pragma Export (C, u00292, "system__val_unsS");
   u00293 : constant Version_32 := 16#c2ca0511#;
   pragma Export (C, u00293, "system__val_realB");
   u00294 : constant Version_32 := 16#f67218ea#;
   pragma Export (C, u00294, "system__val_realS");
   u00295 : constant Version_32 := 16#8f637df8#;
   pragma Export (C, u00295, "ada__characters__handlingB");
   u00296 : constant Version_32 := 16#3b3f6154#;
   pragma Export (C, u00296, "ada__characters__handlingS");
   u00297 : constant Version_32 := 16#92f05f13#;
   pragma Export (C, u00297, "ada__strings__maps__constantsS");
   u00298 : constant Version_32 := 16#ab4ad33a#;
   pragma Export (C, u00298, "ada__directories__validityB");
   u00299 : constant Version_32 := 16#498b13d5#;
   pragma Export (C, u00299, "ada__directories__validityS");
   u00300 : constant Version_32 := 16#2f6496d9#;
   pragma Export (C, u00300, "system__file_attributesS");
   u00301 : constant Version_32 := 16#54ea2fd2#;
   pragma Export (C, u00301, "system__os_constantsS");
   u00302 : constant Version_32 := 16#95f86c43#;
   pragma Export (C, u00302, "system__regexpB");
   u00303 : constant Version_32 := 16#2b69c837#;
   pragma Export (C, u00303, "system__regexpS");
   u00304 : constant Version_32 := 16#f1013930#;
   pragma Export (C, u00304, "gl__filesB");
   u00305 : constant Version_32 := 16#07708aff#;
   pragma Export (C, u00305, "gl__filesS");
   u00306 : constant Version_32 := 16#0460865d#;
