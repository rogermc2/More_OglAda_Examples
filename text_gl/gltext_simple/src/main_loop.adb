...
procedure Main_Loop (Main_Window : in out Glfw.Windows.Window) is
   ...
   Back_Colour    : constant GL.Types.Colors.Color := (0.0, 0.0, 0.25, 1.0);
   ...
   procedure Render  is
      ...
      Text_Colour    : constant Basic_Color := (0.75, 0.25, 0.0);
   begin
   ...
   procedure Setup (Window : in out Glfw.Windows.Window) is
      ...
      Hello          : constant GL.Text.UTF_8_String := "Hello World";
   begin
      ...
      Model_View_Matrix :=  Maths.Translation_Matrix ((50.0, 50.0, 0.0)) * Model_View_Matrix;
      ...
      Texture_Manager.Setup_Graphic (Vertex_Buffer, String_Texture, 50.0, 50.0, 4.0, Hello);

      Model_View_Location :=
          GL.Objects.Programs.Uniform_Location (Rendering_Program, "model_view_matrix");
      Projection_Location :=
